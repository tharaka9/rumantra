        ...
        <div class="row mb-2">
            <div class="col-12">
                <div class="alert alert-icon alert-error alert-bg alert-inline" role="alert">
                    ඔබගේ මාසික ඉලක්කය  රු.1350, එනම් ඔබගේ 25%  discount අඩු වූ පසු රු.1000 හෝ ඊට  වැඩි අවම මාසික ඇණවුම් ඉලක්කය සපුරා නැති වීම හේතුවෙන් ඔබගේ කොමිස් මුදල් ලබා දීම තාවකාලිකව අත් හිටුවා ඇත.
                </div>
            </div>
        </div>';
        }
