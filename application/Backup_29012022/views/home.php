                ...
                <div class="container">
                    ...
                    <div class="row banner-product-wrapper appear-animate">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <?php foreach(array_slice($newarrivalproduct, 0, 8) as $rownewarrival){ ?>
                    ...
                    <div class="row mb-4 appear-animate">
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <?php foreach(array_slice($bestsaleproduct, 1, 6) as $rowbestsale){ ?>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="widget widget-products">
                                <?php foreach(array_slice($featuredproduct, 1, 6) as $rowfeatured){ ?>
                                <div class="product product-widget">
                                    <figure class="product-media">
                                         <a href="<?php echo base_url().'Product/Productview/'.$rownewarrival->productid.'/'.str_replace(' ', '', $rownewarrival->product); ?>">
