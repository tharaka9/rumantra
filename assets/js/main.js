         ...
         Wolmart.$body.on('click', selector, function (e) {
             ...
             setTimeout(function () {
                 ...
                 Wolmart.Minipopup.open({
                     ...
                     actionTemplate: '<a href="'+base_url+'Cart" class="btn btn-rounded btn-sm">View Cart</a><a href="'+base_url+'Cart/Checkout" class="btn btn-dark btn-rounded btn-sm">Checkout</a>'
                 });
             }, 500);
         });
     }
 ...
 (function ($) {
     ...
     function onAddToCartSingle(e) {
         ...
         if ($alert.length) {
             ...
             let baseurl = $('#hidebaseurl').val();
             productName = $this.closest('.product-single').find('.product-title').text();
             var alertHtml = '<div class="alert alert-success alert-cart-product mb-2">\
                             <a href="'+baseurl+'Cart" class="btn btn-success btn-rounded">View Cart</a>\
                             <p class="mb-0 ls-normal">“'+ productName +'” has been added to your cart.</p>\
                             <a href="#" class="btn btn-link btn-close alertclose">\<i class="close-icon"></i>\</a>\
                             </div>'
