...
<header class="header">
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left mr-md-4 my-0">
            ...
            <div class="header-right ml-4">
                <div class="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div class="call-info d-lg-show">
                        ...
                        <a href="tel:0707283848" class="phone-number font-weight-bolder ls-50">070 728 3848</a>
                    </div>
                </div>
                            ...
                            <ul class="menu vertical-menu category-menu bg-white text-default">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'product/productlist/'.$row->idtbl_product_category.'/'.$row->product_category ?>">
                                        <?php if($row->idtbl_product_category==1){ ?>
                                            <img src="<?php echo base_url() ?>images/hairdresser.png" class="mr-3">
                                        <?php }else if($row->idtbl_product_category==2){ ?>
                                            <img src="<?php echo base_url() ?>images/skin-care.png" class="mr-3">
                                        <?php } ?>
