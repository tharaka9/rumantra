    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right pr-0">
                ...
                <a href="<?php if(!empty($_SESSION['user_id'])){echo base_url().'Loginregister/Account'; }else{echo base_url().'Loginregister/Account';} ?>" class="d-lg-show">My Account</a>
    ...
    <div class="header-middle">
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="<?php echo base_url().'Welcome' ?>" class="logo ml-lg-0">
                            <img src="<?php echo base_url('images/logo.jpg');?>" alt="logo" width="145" height="45" />
                        </a>
